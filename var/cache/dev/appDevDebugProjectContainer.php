...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.html2pdf' => 'getApp_Html2pdfService',
    ...
    /**
     * Gets the 'app.html2pdf' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\HTML2PDF A AppBundle\Service\HTML2PDF instance
     */
    protected function getApp_Html2pdfService()
    {
        return $this->services['app.html2pdf'] = new \AppBundle\Service\HTML2PDF();
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('-Q+JFYw-F4', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('-fDx4YjRmf', 0, 'NShGYB2RF+vdJ0MuuAI47L', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_3cdea02ce08164a470d43e474564ee3eef5e9438e7108243e617808637d4015a');
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('31Mp8UsGP7', NULL, 'NShGYB2RF+vdJ0MuuAI47L', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('contact@hopjob974.fr');
        $a->setPassword('Code387400');
        $a->setAuthMode(NULL);
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('5d797082e3f876c609364f814cfa705a7666684d');
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('TeCjw+0gFY', 0, 'NShGYB2RF+vdJ0MuuAI47L', (__DIR__.'/pools'), $this->get('monolog.logger.cache'));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('586bf1a42be539.25062028')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'mailer_user' => 'contact@hopjob974.fr',
            'mailer_password' => 'Code387400',
            'secret' => '5d797082e3f876c609364f814cfa705a7666684d',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '5d797082e3f876c609364f814cfa705a7666684d',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'contact@hopjob974.fr',
            'swiftmailer.mailer.default.transport.smtp.password' => 'Code387400',
