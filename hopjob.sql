...
--
-- Client :  localhost
-- Généré le :  Mar 17 Janvier 2017 à 13:14
...
--
ALTER TABLE `demande_service`
  MODIFY `id_demande_service` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `reponse_annonce`
  MODIFY `id_reponse_annonce` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pour la table `sous_domaine`
--
ALTER TABLE `sous_domaine`
  MODIFY `id_sous_domaine` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pour la table `stat_user`
--
ALTER TABLE `stat_user`
  MODIFY `id_stat_user` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pour la table `type_document`
--
ALTER TABLE `type_document`
  MODIFY `id_type_document` int(11) NOT NULL AUTO_INCREMENT;
--
